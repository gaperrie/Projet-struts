...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/medias/DataTables/datatables.css">
 		...
 		<title><bean:message key="contact.list" /></title>
	</head>
		<body>
			...
			<div class="container">
			<div class="container-fluid">
				<h3 align="center"><bean:message key="contact.list" /></h3><br>
				...
				<table id="contact_table" class="display table table-striped table-condensed table-list">
					<thead>
						<tr>
							...
							<th><bean:message key="contact.nbgroupe" /></th>
					...
					<tbody id="myTable">
						...
						<tr>
							...
							<td><bean:write name="contact" property="nbGroupe" /></td>
							<td><a href="ReadContactById.do?id=<bean:write name="contact" property="id"/>" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-list"></span></a>
							<a href="UpdateContactById.do?id=<bean:write name="contact" property="id"/>" class="btn btn-warning btn-lg"><span class="glyphicon glyphicon-edit"></span></a>
							<a href="DeleteContact.do?id=<bean:write name="contact" property="id"/>&lastName=<bean:write name="contact" property="lastName" />&firstName=<bean:write name="contact" property="firstName" />&email=<bean:write name="contact" property="email"/>" class="btn btn-danger btn-lg"><span class="glyphicon glyphicon-trash"></span></a>
						</tr>
						</logic:iterate>
					</tbody>
				</table>
