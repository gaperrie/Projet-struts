	...
	<body>
			<table border=1>
				...
				<tr>
					...
					<td><a href="InputUpdateContact.do?id=<bean:write name="contact" property="id"/>&lastName=<bean:write name="contact" property="lastName" />&firstName=<bean:write name="contact" property="firstName" />&email=<bean:write name="contact" property="email"/>">Modifier</a></td>
				</tr>
				</logic:iterate>
			</table>
