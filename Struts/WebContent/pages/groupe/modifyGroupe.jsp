...
<html>
	<head>
		...
		<body>
			...
			<div class="container">
			<div class="container-fluid">
				<h3 align="center"><bean:message key="group.update" /></h3><br>
		...
		<html:text property="groupName" value="<%= groupName %>" size="30" maxlength="30" styleClass="form-control"/><html:errors  property="groupName"/><br> 		 
		</div>
		<html:hidden property="groupId" name="groupId" value="<%= groupId %>" />

		

		<html:submit styleClass="btn btn-primary"><bean:message key="action.update" /></html:submit><br>
</html:form>
				...
				<table id="contact_table" class="display table table-striped table-condensed table-list">
					...
					<tbody id="myTable">
						...
						<tr>
							...
							<td><a href="/Struts/DeleteGroupContact.do?groupId=<%= request.getParameter("groupId") %>&contactId=<bean:write name="contact" property="id" />"><bean:message key="action.delete" /></a></td>
						</tr>
						</logic:iterate>
					</tbody>
				</table>
